@extends('layouts.app')
@section('title', 'Mon profil artisan — Harfa.ma')
@section('content')
<div class="portal-layout">
  ...
  <div class="portal-content mb-5">
    ...
    <div class="portal-header">
      ...
      <a href="{{ route('craftsmen.show', $craftsman) }}" class="btn-harfa-ghost" target="_blank">
    ...
    <div class="mb-4 p-3 d-flex align-items-start gap-3"
      ...
      <div style="font-size:13px;color:#713f12;line-height:1.6">
        ...
        <span dir="rtl" style="font-size:12px;color:#92400e">
          {{-- ✔ تأكد من صحة رقم هاتفك — غادي يوصل للعميل مجرد ما يتأكد الحجز. --}}
    ...
    <form method="POST" action="{{ route('craftsman.profile.update') }}" enctype="multipart/form-data">
          ...
          <div class="card-premium">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input class="form-control" name="name" value="{{ old('name', auth()->user()->name) }}" required>
              </div>
              <div class="col-md-6">
                ...
                <input class="form-control" name="phone" value="{{ old('phone', auth()->user()->phone) }}" placeholder="06 00 00 00 00">
              </div>
              <div class="col-md-6">
                <label class="form-label">Ville</label>
                <input class="form-control" name="city" value="{{ old('city', auth()->user()->city) }}" placeholder="Casablanca">
              </div>
              <div class="col-md-6">
                <label class="form-label">Adresse</label>
                <input class="form-control" name="address" value="{{ old('address', auth()->user()->address) }}" placeholder="123 Rue Mohammed V">
              </div>
            </div>
          </div>
          ...
          <div class="card-premium">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" name="description" rows="5"
                ...
                >{{ old('description', $craftsman->description) }}</textarea>
            ...
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input class="form-control" type="number" name="experience_years" min="0" max="50"
                       value="{{ old('experience_years', $craftsman->experience_years) }}" placeholder="Ex: 5">
              </div>
            </div>
            ...
            <div class="mt-3">
                ...
                @if($craftsman->certification)
                  <div class="d-flex align-items-center gap-2 mb-2 p-2"
                    ...
                    <a href="{{ asset('storage/'.$craftsman->certification) }}"
            ...
            <div class="d-flex align-items-center justify-content-between p-3"
              ...
              <div class="form-check form-switch m-0">
                <input class="form-check-input" type="checkbox" name="availability_status"
                       ...
                       {{ $craftsman->availability_status ? 'checked' : '' }}>
              </div>
            </div>
          </div>
            ...
            <div class="row g-2 text-center">
              <div class="col-6">
                <div style="background:#f0fdf4;border-radius:10px;padding:12px">
                  <div style="font-size:20px;font-weight:800;color:#059669">{{ $craftsman->reviews->count() }}</div>
                  <div style="font-size:11px;color:#64748b">Avis reçus</div>
                </div>
              </div>
              <div class="col-6">
                <div style="background:#dbeafe;border-radius:10px;padding:12px">
                  <div style="font-size:20px;font-weight:800;color:#2563eb">{{ number_format($craftsman->averageRating(),1) }}</div>
      ...
      <div class="mt-2 d-flex justify-content-end gap-3">
        <a href="{{ route('craftsman.dashboard') }}" class="btn-harfa-outline">Annuler</a>
