      ...
      <div class="chat-list">
        ...
        <div class="chat-list-scroll">
          <?php $__empty_1 = true; $__currentLoopData = $partners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('client.inbox.chat', $p->id)); ?>"
      ...
      <div class="chat-main">
        <?php if(isset($partner)): ?>
          ...
          <div class="chat-input-area">
            <form method="POST" action="<?php echo e(route('client.inbox.send')); ?>" class="d-flex gap-2 flex-grow-1">
              <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\harfa_cash_only\harfa_complete_fixed\harfa\resources\views/client/inbox.blade.php ENDPATH**/ ?>