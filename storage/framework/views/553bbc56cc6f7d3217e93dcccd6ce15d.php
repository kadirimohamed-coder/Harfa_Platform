...
<div class="container py-4">
  ...
  <section class="hero-section text-center" data-aos="fade-down">
    ...
    <span class="hero-badge">
      <i class="bi bi-stars me-1"></i> #1 Plateforme Artisans au Maroc
    </span>
    ...
    <form action="<?php echo e(route('craftsmen.index')); ?>" method="GET" class="hero-search-card">
              ...
              <div class="artisan-body">
                ...
                <?php if($cm->price): ?>
                  <div style="font-size:14px;font-weight:700;color:#059669">
                    <?php echo e(number_format($cm->price, 0)); ?> DH / intervention
                  </div>
                <?php endif; ?>
              </div>
            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\harfa_cash_only\harfa_complete_fixed\harfa\resources\views/home/index.blade.php ENDPATH**/ ?>