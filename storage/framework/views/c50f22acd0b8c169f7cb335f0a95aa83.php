  ...
  <div class="row g-4">
    ...
    <div class="col-lg-4">
      <div class="card-premium" style="position:sticky;top:88px">
        ...
        <?php else: ?>
          <div class="d-grid">
            <a href="<?php echo e(route('login')); ?>" class="btn-harfa justify-content-center">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Admin\Downloads\harfa_cash_only\harfa_complete_fixed\harfa\resources\views/craftsmen/show.blade.php ENDPATH**/ ?>