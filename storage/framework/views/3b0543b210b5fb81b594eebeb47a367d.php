  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      ...
      <ul class="navbar-nav mx-auto gap-1">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo e(request()->routeIs('craftsmen.*','categories.*') ? 'active' : ''); ?>"
            href="<?php echo e(route('craftsmen.index')); ?>">
...
<?php /**PATH C:\Users\USER\Harfa_Platfomr_maroc\resources\views/partials/nav.blade.php ENDPATH**/ ?>